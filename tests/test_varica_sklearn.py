...
class TestMVARICA(unittest.TestCase):
    ...
    def testModelIdentification(self):
        ...
        scot.backend.sklearn.activate()     # this line is only necessary when changing the backend multiple times in one interpreter session
